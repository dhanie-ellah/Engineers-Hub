...
const FilterOptions = ({ isOpen, setIsOpen }) => {
  return (
    <div
      className={`${
        isOpen ? "hidden" : "block"
      } z-20 fixed left-0 top-[90px] h-full w-full bg-navy-blue-20 shadow-md`}
    >
      <form className="  bg-white py-[20px] px-[100px] flex flex-col gap-7 lg:px-[50px] sm:px-[25px]">
        <div className=" flex items-center justify-between">
          <h1 className=" font-medium text-4xl text-blue sm:text-2xl">Filter search</h1>
          <FontAwesomeIcon
            icon={faClose}
        ...
        <div className=" flex items-center gap-4 sm:flex-col sm:gap-2">
          <div className=" flex flex-col gap-1.5 w-[30%] lg:w-[50%] sm:w-full">
            <label
